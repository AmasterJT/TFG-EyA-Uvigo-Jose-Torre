...
la Figura~\ref{fig:ventanas-secundarias-desktop} muestra algunas de las ventanas secundarias de la aplicación de escritorio, mostrando las diversas de tareas que pueden gestionarse desde estas ventanas especializadas.
...
\begin{subfigure}[t]{0.32\textwidth}
  \centering
  \includegraphics[width=\textwidth]{Imagenes/ventana-secundaria-orden-compra.jpg}
...
\begin{subfigure}[t]{0.32\textwidth}
  \centering
  \includegraphics[width=\textwidth]{Imagenes/ventana-principal-android.jpg}
...
\begin{subfigure}[t]{0.32\textwidth}
  \centering
  \includegraphics[width=\textwidth]{Imagenes/ventana-actualizar-palet-android.jpg}
...
\begin{subfigure}[t]{0.32\textwidth}
  \centering
  \includegraphics[width=\textwidth]{Imagenes/ventana-paletizar-android.jpg}
