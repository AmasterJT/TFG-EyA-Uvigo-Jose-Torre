...
\begin{figure}[H]
\centering
  \includegraphics[width=0.9\textwidth]{Imagenes/ejemplo-navegacion-ventanas-android.png}
...
El script completo de creación del esquema se incluye en el Anexo \ref{anexo:sql-esquema}.


\begin{figure}[H]
\centering
  \includegraphics[width=0.95\textwidth]{Imagenes/diagrama-EER.png}
...
\centering
\rotatebox{90}{%
  \includegraphics[height=0.33\textheight]{../Diagramas-UML/api-componentes-capas/api-componentes-capas.png}%
}
...
\centering
\rotatebox{0}{%
  \includegraphics[width=1\textwidth]{../Diagramas-UML/diagrama-clases-desktop/diagrama-clases-desktop.png}%
}
...
Los diagramas de secuencia permiten representar de forma temporal y ordenada las interacciones entre los distintos componentes del sistema durante la ejecución de determinados casos de uso. Este tipo de diagramas resulta especialmente útil para describir el flujo de mensajes entre interfaces de usuario, servicios de aplicación y componentes de persistencia, así como para identificar responsabilidades y dependencias entre ellos.

En este trabajo se han seleccionado dos diagramas de secuencia representativos, que ilustran procesos clave del sistema y permiten comprender su funcionamiento interno sin necesidad de detallar todas las posibles interacciones existentes.
...
\centering
\rotatebox{0}{%
  \includegraphics[width=0.9\textwidth]{../Diagramas-UML/diagrama-gestion-pedidos/diagrama-gestion-pedidos.png}%
}
...
\centering
\rotatebox{0}{%
  \includegraphics[width=1\textwidth]{../Diagramas-UML/diagrama-modificar-cantidad-palet/diagrama-modificar-cantidad-palet.png}%
}
