...
VALUES
    (
        'sysAdmin',
        'Superusuario con control total del sistema'
    ),
    (
        'Gestor Almacén',
        'Responsable de la operativa del almacén'
    ),
    (
        'Supervisor',
        'Encargado de supervisar las operaciones del almacén'
    ),
    (
        'Operario',
        'Trabajador que realiza tareas diarias en el almacén'
    ),
    (
        'Mantenimiento',
        'Encargado del mantenimiento de maquinaria e instalaciones'
    ),
    (
        'Administración',
        'Encargado de tareas administrativas del almacén'
    );
